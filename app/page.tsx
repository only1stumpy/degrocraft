          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="#join"
                  className="group relative flex items-center justify-center gap-3 px-6 py-4 bg-white text-slate-800 hover:bg-white/90 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/20"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
                ...
                <a
                  href="#about"
                  className="flex items-center justify-center gap-2 px-6 py-4 bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/40 rounded-xl font-semibold transition-all duration-300"
                >
                  Узнать больше
                  <svg
                    className="w-4 h-4"
              ...
              <div className="flex gap-6 pt-4">
                <div className="flex flex-col items-center p-4 bg-white/5 rounded-xl border border-white/10">
                  <svg
                    className="w-6 h-6 text-white/80 mb-1"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                  </svg>
                  <span className="text-lg font-bold text-white">Ламповый</span>
                ...
                <div className="flex flex-col items-center p-4 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <span className="text-lg font-bold text-white">1.21.11</span>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              {
                step: "02",
                title: "Получи приглашение",
                description: "Если всё ок — получишь IP сервера",
                icon: (
                  <svg
                    className="w-6 h-6"
                    viewBox="0 0 24 24"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 text-white/40 text-sm">
              ...
              <span>
                ...
                <a href="https://t.me/only1stumpy">only1stumpy</a>
              </span>
            </div>
          </div>
        </div>
